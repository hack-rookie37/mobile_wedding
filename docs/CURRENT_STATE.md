...
- 최종 갱신: 2026-07-23 (스키마 v20 — 전이 v19 치유 — ADR-058 / 쓰기 효과 글자별 페이드 재구현 — ADR-054 / RSVP 동의 체크박스 제거 — ADR-055, DB 마이그레이션 적용됨 / 공유 버튼 스크롤 표시 — ADR-056 / 인사말 라벨 위 장식 이미지+높이 — ADR-057)
